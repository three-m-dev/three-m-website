        ...
        <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3">
            ...
            <div>
              ...
              <div className="mt-4">
                ...
                <p className="mt-4 leading-relaxed text-gray-700">
                  When we approached Three M with a complex custom job, I wasn't
                  sure if it could be done to our specifications. Not only did
                  they deliver on time, but the quality was beyond what we had
                  hoped for. A true testament to their expertise.
                </p>
              </div>
            </div>

            <footer className="mt-4 text-sm font-medium text-gray-700 sm:mt-6">
              &mdash; Jordan R., Lead Engineer at TechSolutions
            </footer>
          </blockquote>
          ...
          <blockquote className="flex h-full flex-col justify-between bg-white p-6 shadow-sm sm:p-8">
            <div>
              ...
              <div className="mt-4">
                ...
                <p className="mt-4 leading-relaxed text-gray-700">
                  We've been partnering with Three M for over two years now, and
                  they never disappoint. Their team's dedication to precision
                  and timely delivery has made our production process smoother
                  and more efficient.
                </p>
              </div>
            </div>
            ...
            <footer className="mt-4 text-sm font-medium text-gray-700 sm:mt-6">
              &mdash; Maria V., Production Manager at DynaCraft
            </footer>
          </blockquote>
          ...
          <blockquote className="flex h-full flex-col justify-between bg-white p-6 shadow-sm sm:p-8">
            <div>
              ...
              <div className="mt-4">
                <p className="text-2xl font-bold text-primary sm:text-3xl">
                  Top-Notch CAD Services
                </p>

                <p className="mt-4 leading-relaxed text-gray-700">
                  I was particularly impressed by Three M's CAD design team.
                  They transformed our rough sketches into detailed, workable
                  blueprints, providing valuable insights along the way. Their
            ...
            <footer className="mt-4 text-sm font-medium text-gray-700 sm:mt-6">
              &mdash; Liam S., Product Designer at InnovateTech
            </footer>
          </blockquote>
        </div>
      </div>
