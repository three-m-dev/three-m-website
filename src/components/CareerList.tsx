      ...
      <div className="mx-auto max-w-screen-xl px-4">
          ...
          <div className="-mx-3 mb-10 flex flex-wrap items-center justify-center">
            <div className="mb-3 w-full px-3 md:mb-0 md:w-1/3">
              <div className="relative border border-gray-200 bg-white shadow-md">
                ...
                <select className="w-full appearance-none border-0 bg-transparent px-4 py-3 leading-6 text-gray-500 outline-none hover:cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary focus:ring-opacity-50">
            ...
            <div className="w-full px-3 md:w-1/3">
              <div className="relative border border-gray-200 bg-white shadow-md">
                ...
                <select
                  className="w-full appearance-none border-0 bg-transparent px-4 py-3 leading-6 text-gray-500 outline-none hover:cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary focus:ring-opacity-50"
                  name=""
                >
        ...
        {openPositions.map((position, index) => (
          <div key={index} className="mb-4 flex flex-col py-4 md:flex-row">
            <div className="mb-4 flex w-full items-center md:mb-0 md:mr-auto md:w-auto">
            ...
            <div className="mb-6 w-full md:mb-0 md:w-auto md:flex-grow">
              <div className="flex h-full items-center">
                <div className="inline-flex items-center md:ml-4">
                  <svg
